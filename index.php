...
<div class="bgded overlay" style="background-image:url('images/cover.jpeg');"> 
  <!-- ################################################################################################ -->
  <div class="wrapper row1">
    <header id="header" class="hoc clear"> 
      <!-- ################################################################################################ -->
      <div id="logo" class="fl_left">
        <h1><a href="index.html">Technopandas</a></h1>
      </div>
      <nav id="mainav" class="fl_right">
        <ul class="clear">
          ...
          <li><a class="drop" href="#">Installations</a>
            <ul>
              
              <li><a class="drop" href="hadoop.php">Hadoop</a>
                <ul>
                  <li><a href="#">Single Node</a></li>
                  <li><a href="#">Pseudo-distributed</a></li>
                  <li><a href="#">Multinode</a></li>
                </ul>
              </li>
              <li><a href="#">Python</a></li>
              <li><a href="#">XAMPP</a></li>
              <li><a href="#">XAMPP + Python-cgi</a></li>
            </ul>
          </li>
